...
def _components(
    ...
    return (
        Component(
            "Neural Extractor V3",
            "3.0.8",
            "MIT (declared; owner/year unresolved)",
            "UNRESOLVED - root LICENSE lacks an approved legal owner/year",
            ...
            "Locally authored/modified project; exact distributed authorship chain UNRESOLVED",
            "HOLD until an authorized owner/year and complete rights chain are confirmed; "
            "ship LICENSE and corresponding build/source inputs.",
        ),
        Component(
...
def render_inventory(
    ...
    lines.extend(
        [
            ...
            "",
            "Open audit blockers (7)",
            "-----------------------",
            "",
            "1. Application copyright owner(s) and applicable year(s) are not authorized.",
            "2. The one-file LGPL replacement/relink procedure is not yet independently tested.",
            "3. Complete FFmpeg Corresponding Source and a distributor-controlled delivery method are absent.",
            "4. The CPython/python-build-standalone transitive source and recipe closure needs final review.",
            "5. Microsoft runtime redistribution coverage for every inventoried DLL is unconfirmed.",
            "6. Qt/PySide notice, attribution, source, and software-render fallback closure needs final review.",
            "7. Qualified legal review has not approved the distribution or external-helper classification.",
            "",
            ...
            "requires complete source/notice/relink closure, reproducibility evidence, approved",
            "application copyright ownership/year, and qualified legal review.",
            "",
        ]
    )
    return "\n".join(lines)
