...
class AutoUpdater:
    ...
    def run_auto_update(self, update_file=True):
        ...
        try:
            ...
            self.logger.info(f"Update complete: {updated_count}/{len(outdated_packages)} packages updated")
...
def create_updater_with_callback(requirements_file="requirements.txt", 
    ...
    if task_in_progress_callback:
        original_check = updater.is_task_in_progress
