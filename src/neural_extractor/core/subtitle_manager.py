...
class SubtitleSignalEmitter:
    ...
    def emit_complete(self, result: Path | None) -> None:
...
class SubtitleManager:
    ...
    def __init__(
        self, output_dir: Path | None = None, cookie_file: Path | None = None
    ) -> None:
    ...
    def get_subtitles(self, video_url: str, video_title: str, lang: str = "nl") -> Path | None:
    ...
    def _try_native_track(self, video_url: str, video_title: str, lang: str) -> Path | None:
        ...
        try:
            ...
            with yt_dlp.YoutubeDL(ydl_opts) as ydl:
                ...
                if lang in subtitles:
                    ...
                    # Rename
                    self.output_dir / f"{video_title}.{lang}.srt"
    ...
    def _try_transcript_api(self, video_url: str, video_title: str, lang: str) -> Path | None:
        ...
        try:
            ...
            transcript = YouTubeTranscriptApi.get_transcript(
                video_id, languages=[lang, "auto"], **kwargs
            )
    ...
    def _try_whisper_transcription(
        self, video_url: str, video_title: str, lang: str
    ) -> Path | None:
    ...
    def _download_audio(self, video_url: str, video_title: str) -> Path | None:
