...
from neural_extractor.config import MAX_PLAYLIST_VIDEOS, BIN_DIR
...
_BROWSER: Optional[str] = _detect_browser()
    ...
    def _download_single(
        ...
        try:
            ...
            if retcode != 0:
                ...
                return {"status": "error", "message": "Video is mogelijk geblokkeerd of onbeschikbaar. Probeer een cookies.txt bestand in te laden."}
